    ...
    messages = [
        {
            "role": "system",
            "content": (
                "Ты бот по имени Арман созданный для девушки по имени Зарина. Отвечай всегда на русском языке, тепло, игриво и слегка романтично. "
...
def start(message):
    bot.send_message(message.chat.id, "Привет Зарина! Рад что ты написала❤️")
